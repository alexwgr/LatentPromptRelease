...
from models.promptresponse_complex import PromptResponseComplex
from models.promptresponse_flat import PromptResponseFlat
from models.prompt_latent_type_concatv2 import PromptLatentTypeConcatModelV2
from models.prompt_latent_type_concatv3 import PromptLatentTypeConcatModelV3
from models.prompt_latent_type_concatvgated import PromptLatentTypeConcatModelGated
from models.prompt_latent_type_interp import PromptLatentTypeModelInterp
...
from models.prompt_latent_type_concatv2_perp_latent_entropy import PromptLatentTypeConcatModelV2PerpLatentEntropy
...
def train():
	...
	#Exclude set of discriminative questions
	examples = exclude_questions_from_set(examples, "remove_questions_binary.txt")

	#Model can be run with glove or fixed BERT embeddings 
	...
	for test_num in range(FLAGS.num_tests):
		...
		#Stratify based on split indices
		...
		with tf.Graph().as_default():             		
			...
			with sess.as_default(): 
				...
				#Get model predictions on a specific set
				...
				for batch_indices in batches:
					...
					if current_step % (FLAGS.evaluate_every * batches_per_epoch)  == 0:
						...
						#Save a regular record of current dev performance for hyperparemeter analysis
...
# save record of performance to file
